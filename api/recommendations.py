...
class handler(BaseHTTPRequestHandler):
    def do_POST(self):
        try:
            ...
            # Path to the script
            script_path = os.path.join(os.path.dirname(__file__), '../python_scripts/generate_recommendations.py')
            ...
            response_data = {
                ...
                'summary': {
                    ...
                    'processType': 'ai_recommendations'
                }
            }
            ...
            response_data = {
                'success': False,
                'error': str(e),
                'logs': ['Failed to generate recommendations']
            }
